/*
 * Not done YET!!!
 * I simply can't be arsed to write this right now...
 */

#ifndef LEARNING_PROJECTS_TICTACTOE_MANAGER_HPP
#define LEARNING_PROJECTS_TICTACTOE_MANAGER_HPP
#include "tictactoe_board.hpp"

class tictactoe_manager {
    static tictactoe_coordinate parse_coordinate(const std::string &coordinate_string) {
...
public:
    static void init_game_and_start_game_loop() {
        ...
        while (true) {
            ...
            while (!valid) {
                ...
                try {
                    ...
                    if (coordinate.x > tictactoe_board::board_size - 1 ||
                        coordinate.y > tictactoe_board::board_size - 1 || ttt_board.is_occupied(coordinate) ||
...
#endif // LEARNING_PROJECTS_TICTACTOE_MANAGER_HPP
